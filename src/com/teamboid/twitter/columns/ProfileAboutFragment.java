...
public class ProfileAboutFragment extends Fragment implements IBoidFragment {
    ...
    public boolean isBlocked() {
        return ourRelationship.isSourceBlockingTarget();
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    setItem(R.id.tweetNo, getString(R.string.tweets_str), currentUser.getStatusesCount() + "");

                    double tweetsPerDay = currentUser.getStatusesCount();
                    ...
                    setItem(R.id.favorites, getString(R.string.favorite_str), currentUser.getFavouritesCount() + "");
    ...
    void updateFollowButton() {
        try {
            ourRelationship = AccountService.getCurrentAccount().getClient().showFriendship(AccountService.getCurrentAccount().getId(), currentUser.getId());
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (ourRelationship == null) {
                    ...
                    } else if (currentUser.isFollowRequestSent()) {
    ...
    public void onStart() {
        ...
        getView().findViewById(R.id.location).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String loc = null;
                try {
                    loc = URLEncoder.encode(currentUser.getLocation(), "UTF-8");
                } catch (Exception e) {
                    e.printStackTrace();
                }
