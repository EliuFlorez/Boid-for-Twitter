...
import me.kennydude.awesomeprefs.*;
...
//          TODO  accountId = this.getArguments().getLong("accountId");
            ...
            findPreference("delete_media_cache").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference pref) {
                    ...
                    new Thread(new Runnable() {
                        public void run() {
                            File[] internal = getActivity().getCacheDir().listFiles();
                            File[] external = getActivity().getExternalCacheDir().listFiles();
                            for (File fi : internal) fi.delete();
                            for (File fi : external) fi.delete();
