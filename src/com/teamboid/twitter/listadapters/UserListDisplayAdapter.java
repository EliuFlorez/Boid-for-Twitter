...
public class UserListDisplayAdapter extends BaseAdapter {
            ...
            diag.setPositiveButton(R.string.yes_str, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    new Thread(new Runnable() {
                        public void run() {
                            try {
                                AccountService.getCurrentAccount().getClient().destroyUserList(getListId(pos));
            ...
            diag.setPositiveButton(R.string.yes_str, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    new Thread(new Runnable() {
                        public void run() {
                            try {
                                AccountService.getCurrentAccount().getClient().destroyUserListSubscription(getListId(pos));
                            } catch (final Exception e) {
                                e.printStackTrace();
                                mContext.runOnUiThread(new Runnable() {
                                    public void run() {
    ...
    public UserList[] toArray() {
        return lists.toArray(new UserList[0]);
    }
}
