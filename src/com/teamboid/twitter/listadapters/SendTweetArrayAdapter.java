...
public class SendTweetArrayAdapter extends ArrayAdapter<SendTweetTask> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.send_tweet, null);
        }
        ...
        NetworkedCacheableImageView profilePic = (NetworkedCacheableImageView) convertView.findViewById(R.id.feedItemProfilePic);
        profilePic.loadImage(stt.from.getUser().getProfileImageURL(), false);
