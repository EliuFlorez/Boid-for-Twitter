...
public class MessageItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final NetworkedCacheableImageView profileImgView = (NetworkedCacheableImageView) toReturn.findViewById(R.id.dmItemProfileImg);
        if (PreferenceManager.getDefaultSharedPreferences(context).getBoolean("enable_profileimg_download", true)) {
            ...
            profileImgView.loadImage(Utilities.getUserImage(curItem.getSenderScreenName(), context), false);
        } else {
