...
public class MediaFeedListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final NetworkedCacheableImageView img = (NetworkedCacheableImageView) toReturn.findViewById(R.id.mediaItemImage);
        final View prog = toReturn.findViewById(R.id.mediaItemProgress);

        img.setScaleType(ScaleType.CENTER_CROP);
        img.loadImage(tweets.get(position).imgurl, false);
        return toReturn;
    }
